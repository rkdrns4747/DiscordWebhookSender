...
public enum Lang {
    KR(Map.ofEntries(
            ...
            Map.entry(Messages.CHOOSE_AVATAR, "파일 선택"),
    ...
    US(Map.ofEntries(
            ...
            Map.entry(Messages.CHOOSE_AVATAR, "Open"),
    ...
    JP(Map.ofEntries(
            ...
            Map.entry(Messages.WEBHOOK_CHANGE_SUCCESS_TITLE, "完了"),
            ...
            Map.entry(Messages.CHOOSE_AVATAR, "ファイル選択"),
